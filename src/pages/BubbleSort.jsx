...
function OrdenamientoBurbuja() {
  ...
  const agregarValor = () => {
    ...
    setNuevoValor('');
    ordenarPorBurbuja(nuevoArreglo);
  };
      ...
      {arr.map((valor, index) => (
        <div 
          ...
          className={`px-3 py-1 rounded-full text-sm font-semibold ${
            index === paso || index === paso + 1 ? 'bg-yellow-300 text-gray-800' : 'bg-gray-200 text-gray-700'
          }`}
        >
          {valor}
        </div>
  ...
  return (
    <div className="flex flex-col items-center space-y-4 p-4">
      <h1 className="text-2xl font-bold">Ordenamiento Burbuja</h1>
...
export default OrdenamientoBurbuja;