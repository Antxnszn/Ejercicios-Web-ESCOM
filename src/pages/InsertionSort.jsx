...
function OrdenamientoInsercion() {
  ...
  const agregarValor = () => {
    ...
    setNuevoValor('');
    ordenarPorInsercion(nuevoArreglo);
  };
  ...
  return (
    <div className="flex flex-col items-center space-y-4 p-4">
      <h1 className="text-2xl font-bold">Ordenamiento por Inserción</h1>
...
export default OrdenamientoInsercion;